...
var headerFields = map[string]func(*model.Invoice, string){
	...
	"sender_vat_id_sanitized":    func(i *model.Invoice, v string) { i.SupplierVAT = v },
	...
	"recipient_vat_id_sanitized": func(i *model.Invoice, v string) { i.CustomerVAT = v },
...
// value - such as one reading sender_vat_id_sanitized to look up a vendor.
